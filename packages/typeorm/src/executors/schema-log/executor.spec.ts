...
import logSchema from './executor.js';
...
describe('schema-log executor', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = mkdtempSync(join(tmpdir(), 'nx-typeorm-schema-log-'));
  ...
  it('invokes schema:log with inferred datasource', async () => {
