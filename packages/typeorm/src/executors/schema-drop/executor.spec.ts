...
import dropSchema from './executor.js';
...
describe('schema-drop executor', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = mkdtempSync(join(tmpdir(), 'nx-typeorm-schema-drop-'));
  ...
  it('invokes schema:drop with inferred datasource', async () => {
