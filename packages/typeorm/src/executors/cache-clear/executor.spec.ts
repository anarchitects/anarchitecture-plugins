...
import clearCache from './executor.js';
...
describe('cache-clear executor', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = mkdtempSync(join(tmpdir(), 'nx-typeorm-cache-clear-'));
  ...
  it('invokes cache:clear with inferred datasource', async () => {
