...
import syncSchema from './executor.js';
...
describe('schema-sync executor', () => {
  ...
  beforeEach(() => {
    ...
    tempDir = mkdtempSync(join(tmpdir(), 'nx-typeorm-schema-sync-'));
  ...
  it('invokes schema:sync with inferred datasource', async () => {
