...
Example:
- tools/governance/profiles/angular-cleanup.json => profile angular-cleanup
...
- Prefer angular-cleanup when present.
...
## Acceptance Criteria
- AC-1: Creating tools/governance/profiles/angular-cleanup.json makes governance targets appear without manual config edits.
