...
It does not claim repo-wide removal of every historical `projectId`-shaped field in unrelated internal translators or document builders.
...
- Historical or transitional hits outside that narrow surface need explicit triage before epic closure.
